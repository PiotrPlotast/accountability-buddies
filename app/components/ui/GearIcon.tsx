...
/**
 * A gear, drawn rather than typed — the same reasoning as `PencilIcon`: the
 * "⚙" character has no glyph in Geist Mono and falls back per platform.
 */
export default function GearIcon({ color, size = 18 }: Props) {
  return (
